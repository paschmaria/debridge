                            ...
                            @if(auth()->user()->id != $user->id)
                                ...
                                @if(auth()->user()->checkRole())
                                    @if(in_array($user->id, auth()->user()->friends->pluck('id')->toArray()))
                                        <button class="btn btn-sm waves-light waves-effect btn-brand" data-toggle="modal" data-target="#cancel-modal{{ $user->reference }}" id="friend-req{{ $user->reference }}">
                                    ...
                                    @else
                                        @if(!in_array($user->id, auth()->user()->sent_requests->pluck('id')->toArray()))
                                            ...
                                            <button class="btn btn-sm waves-light waves-effect btn-outline-brand send-friend-request" id="friend-req{{ $user->reference }}" data-reference="{{ $user->reference }}" >Send Friend Request</button></a>
                                        @else
                                            <button class="btn btn-sm waves-light waves-effect btn-brand" data-toggle="modal" data-target="#cancel-request-modal{{ $user->reference }}" id="friend-req{{ $user->reference }}">Cancel Friend Request</button>
                                        @endif
                            ...
                            @if(auth()->check() && auth()->user()->id != $user->id)
                                ...
                                @if(!auth()->user()->checkRole())
                                    @if(in_array($user->id, auth()->user()->trade_partners->pluck('id')->toArray()))
                                        <button class="btn btn-sm btn-brand" data-toggle="modal" data-target="#cancel-modal{{ $user->reference }}" id="trade-req{{ $user->reference }}">
                                    ...
                                    @else
                                        @if(!in_array($user->id, auth()->user()->sent_trade_requests->pluck('id')->toArray()))
                                            ...
                                            <button class="btn btn-sm btn-outline-brand send-trade-request no-js" id="trade-req{{ $user->reference }}" data-reference="{{ $user->reference }}">Send Trade Request</button></a>

                                        @else
                                            <button class="btn btn-sm btn-brand" data-toggle="modal" data-target="#cancel-request-modal{{ $user->reference }}" id="trade-req{{ $user->reference }}">Cancel Trade Request</button>
                                        @endif
                                    @endif
                                @endif
