	        ...
	        <div class="m-t-40 m-b-140">
	        	<div class="row">
	        		...
	        		<div class="col-md-6 col-sm-6 col-xs-6 col-12">
	        			<!-- first friend -->
	        			<div class="btn bg-brand col-sm-12">Bridgers you are following <span class="badge">{{ $following_count }}</span></div>
	        			...
	        			@empty
	        				<p>You are currently following no body</p>
	        			@endforelse
	        		</div>
	        		<!-- / first column of friends -->
	        		...
	        		<div class="col-md-6 col-sm-6 col-xs-6 col-12">
	        			<!-- first friend -->
	        			<div class="btn bg-brand col-sm-12">Bridgers who follow you <span class="badge">{{ $followers_count }}</span></div>
	        			...
	        			@empty
	        				<p>You haven't got any followers yet</p>
	        			@endforelse
	        		</div>
	        		<!-- / second column of friends -->
	        	</div>
