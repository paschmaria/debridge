    	...
    	<div class="container">
	        ...
	        <div class="m-t-40 m-b-140">
	        	<div class="row">
	        		...
	        		<div class="p-10 m-b-20 bg-brand col-sm-12">BRIDGERS {{ $user->full_name() }} IS FOLLOWING <span style="color: #000;" class="badge white follow_count" >{{ $following_count }}</span></div>
