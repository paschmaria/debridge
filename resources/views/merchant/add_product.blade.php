                ...
                <form action="{{ route('addProduct') }}" method="POST">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-12 form-group{{ $errors->has('product_price') ? ' has-error' : '' }}">
                            ...
                            <input type="number" name="last_name" id="usr-lname" class="form-control bd-3 h-40 input-alternate border-box" required value="{{ old('product_price') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-12 form-group">
                            ...
                            <select name="gender" id="usr-gender" class="form-control bd-3 h-40 validate input-alternate border-box input-shadow" required value = "{{ old('category') }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-12 form-group{{ $errors->has('quantity') ? ' has-error' : '' }}">
                            <label for="date_of_birth" data-error="wrong" data-success="right">Quantity</label>
                            <input type="number" name="date_of_birth" id="usr-dob" class="form-control bd-3 h-40 validate input-alternate border-box" required value="{{ old('quantity') }}">
