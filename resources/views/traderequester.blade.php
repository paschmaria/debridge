...
<html lang="en">
<head>
	<title>De-Bridge Follow Merchants Request</title>
    <meta charset="utf-8">
    ...
    <section class="main">
    	<div class="container">
    		<div id="navbarNav1 m-t-40">
	            <h3 class="h3-responsive c-brand f-24 m-t-30 m-b-8">ADD TO MERCHANT'S LIST</h3>
	            <div class="h-58">
	            	<p class="c-gray f-14 dis-inline-b">Follow More merchants to view more products</p>
	        		...
	        		<div class="col-md-6">
	        				...
	        				<div class="row">
	        					<div class="col-md-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="assets/img/pphoto-10.jpeg" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
										<p class="f-14">MERCHANT’S NAME</p>
										<p class="f-12">42, Montgomerry road, Yaba.</p>
										<p class="f-12">Dealers in all kinds of game console</p>
									</div>
		        				</div>
		        				<div class="col-md-4">
		        					<button class="f-14 width-130 c-brand h-30 btn-outline-brand m-t-40 m-b-50"><span class="fa fa-plus">&nbsp; &nbsp; Follow</span></button>
		        				</div>
	        				</div>
	        			</div>
	        			<!-- / first friend -->
	        			...
	        			<div class="h-114 width-563 m-b-30">
	        				<div class="row">
	        					<div class="col-md-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="assets/img/pphoto-2.jpeg" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
	        			...
	        			<div class="h-114 width-563 m-b-30">
	        				<div class="row">
	        					<div class="col-md-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="assets/img/pphoto-4.jpg" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
						...
						<div class="h-114 width-563 m-b-30">
	        				<div class="row">
	        					<div class="col-md-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="assets/img/pphoto-9.jpeg" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
	        			...
	        			<div class="h-114 width-563 m-b-30">
	        				<div class="row">
	        					<div class="col-md-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="assets/img/p-photo-6.jpeg" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
	        			...
	        			<div class="h-114 width-563 m-b-30">
	        				<div class="row">
	        					<div class="col-md-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="assets/img/pphoto-5.jpeg" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
	        			...
	        			<div class="h-114 width-563 m-b-30">
	        				<div class="row">
	        					<div class="col-md-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="assets/img/pphoto-301.jpeg" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
	        		...
	        		<div class="col-md-6">
	        			...
	        			<div class="h-114 width-563 m-b-30">
	        				<div class="row">
	        					<div class="col-md-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="assets/img/pphoto-3.jpeg" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
	        			...
	        			<div class="h-114 width-563 m-b-30">
	        				<div class="row">
	        					<div class="col-md-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="assets/img/pphoto-8.jpeg" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
		        				...
		        				<div class="col-md-4">
		        					<button class="f-14 width-130 c-brand h-30 btn-outline-brand m-t-40 m-b-50"><span class="fa fa-plus">&nbsp; &nbsp;</span>Follow</button>
		        				</div>
	        				</div>
	        			</div>
	        			<!-- / second friend-->
	        			...
	        			<div class="h-114 width-563 m-b-30">
	        				<div class="row">
	        					<div class="col-md-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="assets/img/pphoto-7.jpeg" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
	        			...
	        			<div class="h-114 width-563 m-b-30">
	        				<div class="row">
	        					<div class="col-md-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="assets/img/pphoto-1.jpg" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
