...
<html lang="en">
    ...
    <body data-page="products-page">
                ...
                <div class="container-fluid">
                    ...
                    <div id="navbarNav1" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item m-r-10"><a class="nav-link hover-underline text-uppercase" href="#">Trade Line</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="hidden-xs-down col-sm-3 col-md-3 text-center m-t-60">
                        <img src="assets/img/icons/playstation.png" alt="User-pic" class="img-fluid dis-inline-b">
                    </div>
                            ...
                            <div class="col-md-3 col-sm-6 col">
                                <div class="card m-t-20">
                                    ...
                                    <div class="view overlay hm-black-light p-5 hm-zoom">
                                        <img src="assets/img/products/leftside-ad-3.png" class="img-fluid width-100p" alt="">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="media m-b-40">
                                    <a class="pull-left" href="#">
                                        <img class="media-object p-r-10" src="assets/img/acc-img-2.png" alt="Image">
                                    </a>
                                    <div class="media-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <figure class="col-md-6">
                                                <img src="assets/img/cart/rectangle-7.png" class="m-l-90">
                                            </figure>
                                            <figure class="col-md-6">
                                                <img src="assets/img/cart/rectangle-7.png">
                                            </figure>
                                            <figure class="col-md-6">
                                                <img src="assets/img/cart/rectangle-7.png" class="m-l-90">
                                            </figure>
        ...
        <!-- JQuery -->
        <script type="text/javascript" src="assets/plugins/mdb/js/jquery-3.1.1.js"></script>
