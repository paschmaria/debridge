    ...
    <section class="main">
    	<div class="container">
    		<div id="navbarNav1 m-t-40">
	            <h3 class="h3-responsive c-brand f-24 m-t-30 m-b-8">ADD TO FRIEND'S LIST</h3>
	            <div class="h-30">
	            	<p class="c-gray f-14 dis-inline-b">Follow more friends to view more products</p>
	            </div>
	        </div>
	        <!-- friends display  -->
	        		...
	        		<div class="col-md-6">
	        				...
	        				<div class="row">
	        					<div class="col-md-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="{{ asset('img/pphoto-3.jpeg') }}" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 col-sm-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
										<p class="f-14 m-t-30">JHUD EJIKE</p>
										<p class="f-12">Business owner at Sony.</p>
									</div>
		        				</div>
		        				<div class="col-md-4 col-sm-4">
		        					<button class="btn btn-sm f-14 c-brand btn-outline-brand m-t-40 m-b-50"><span class="fa fa-plus">&nbsp; &nbsp;</span>Follow</button>
		        				</div>
	        				</div>
	        			</div>
	        			<!-- / first friend -->
	        			...
	        			<div class="h-114 width-563 m-b-30">
	        				<div class="row">
	        					<div class="col-md-3 col-sm-3">
	        						<div class="profile-picture dis-inline">
			        					<img src="{{ asset('img/pphoto-1.jpg') }}" class="p-10">
			        				</div>
	        					</div>
		        				<div class="col-md-5 col-sm-5 p-t-10">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
						...
						<div class="h-114 width-563 m-b-30">
	        				<div class="row">
		        				...
		        				<div class="col-md-5 col-sm-5 p-t-35">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
						...
						<div class="h-114 width-563 m-b-30">
	        				<div class="row">
		        				...
		        				<div class="col-md-5 p-t-35">
		        					<div class="profile-description dis-inline width-200 h-114 c-gray-medium">
										<p class="f-14">JHUD EJIKE</p>
										<p class="f-12">Business owner Sony</p>
									</div>
		        				</div>
		        				<div class="col-md-4">
		        					<button class="btn btn-sm f-14 c-brand btn-outline-brand m-t-40 m-b-50"><span class="fa fa-plus">&nbsp; &nbsp;</span>Follow</button>
