                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card h-300">
                                    ...
                                    <div class="image-circle">
                                        <img src="{{ asset('img/rectangle-5.png') }}" class="m-l-5 pos-abs b-29">
                                    </div>
                                    <!--/ black circle -->
                                    <!-- card content block-->
                                    <div class="card-block">
                                        <div class="card-content pos-abs m-t-10">
                                            <h4 class="f-14" style="color:#212121;">Business Name</h4>
                                            <p class="f-12" style="color:#526173;">Ikorodu, Lagos</p>
                                            <div class="ratings_wrapper m-t-10 p-b-20">
                         ...
                         <div class="row m-t-30">
                            ...
                            <div class="col-md-3">
                                <div class="card h-300">
                                    ...
                                    <div class="card-block">
                                        <div class="card-content pos-abs m-t-10">
                                            <h4 class="f-14 m-b-5" style="color:#212121;">Business Name</h4>
                                            <p class="f-12"  style="color:#526173;">Ikorodu, Lagos</p>
                                            <div class="ratings_wrapper m-t-10 p-b-20">
                                                <span class="fa fa-star"></span>
                                                <span class="fa fa-star"></span>
