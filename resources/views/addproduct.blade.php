                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-12 m-t-10">
                                <ul class="navbar-nav dis-flex flex-row">
                                    ...
                                    <li class="animated bounceIn"> 
                                        <a class="p-l-10 p-r-10 dropdown white-text" d="dropdownNotify" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span class="pos-rel z-5000">
        ...
        <section class="main">
          <div class="container bd-dark-light m-t-60 width-800 h-800">
            ...
            <form class="m-t-40">
                <div class="row">
                    <div class="col-md-4">
                        <div class="">
                            ...
                            <input type="text" name="usrname" id="usrname" class="form-control bd-3 h-40 input-alternate border-box bg-white">
                        </div>
                    </div>
                </div>
                <div class="row">
                   <div class="col-md-4 sm-6">
                        <div class="">
                            ...
                            <textarea type="text" name="usrname" class="form-control bd-3 h-150 input-alternate border-box md-textarea bg-white"></textarea> 
                        </div>
                    </div>
                </div>
                <div class="row">
                   <div class="col-md-4 sm-6">
                        <div class="">
                            ...
                            <input type="text" name="usrname" class="form-control bd-3 h-40 input-alternate border-box bg-white">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <button type="button" class="btn btn-lg btn-outline-brand m-l-60">Post</button>
                </div>
            </form>
          </div>
        </section>
