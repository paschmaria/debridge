...
<html lang="en">
<head>
	<title>De-Bridge Follow Merchants</title>
    <meta charset="utf-8">
	        		...
	        		<div class="col-md-6">
	        			...
	        			<div class="h-114 width-563 m-b-30">
	        				<div class="row">
		        				...
		        				<div class="col-md-4">
		        					<button class="f-14 width-130 c-brand h-30 btn-outline-brand m-t-40 m-b-50"><span class="fa fa-check">&nbsp; &nbsp;</span>Following</button>
		        				</div>
	        				</div>
	        			</div>
	        			<!-- / second friend-->
						...
						<div class="h-114 width-563 m-b-30">
	        				<div class="row">
		        				...
		        				<div class="col-md-4">
		        					<button class="f-14 width-130 c-brand h-30 btn-outline-brand m-t-40 m-b-50"><span class="fa fa-plus">&nbsp; &nbsp;</span>Following</button>
		        				</div>
	        				</div>
	        			</div>
	        			<!-- / 4th friend -->
