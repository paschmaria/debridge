    	...
    	<div class="container">
    		<div id="navbarNav1 m-t-40">
	            ...
	            <div class="h-58">
	            	...
	            	<button class="pull-right f-17 m-b-10 h-40 bg-brand-lite btn-outline-brand c-white"><a href="{{url('users/follow/more')}}" class="c-brand"><span class="fa fa-plus m-r-10"></span>Follow Merchants</a></button>
	            </div>
	        </div>
	        <!-- friends display  -->
