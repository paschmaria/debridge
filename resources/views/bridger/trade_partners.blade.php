		        		...
		        		@foreach($users as $user)
	        				...
	        				<div class="">
		        				<div class="row">
			        				...
			        				<button class="btn btn-sm f-12 waves-light waves-effect btn-outline-brand m-t-40 m-b-50" data-email="{{$user->reference}}">cancel partnersip <i class="fa fa-times"></i></button>
			        				</div>
			        				<!-- Modal delete -->
				                    <div class="modal fade m-t-180" id="delete-modal{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
