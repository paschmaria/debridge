    ...
    <section class="main">
    	<div class="container">
    		<div id="navbarNav1 m-t-40">
	            <h3 class="h3-responsive c-brand f-24 m-t-30 m-b-8">FRIEND REQUESTS</h3>
	            <div class="h-58">
	            	<a href="{{ route('more_friends') }}"><button class="btn btn-md btn-sm pull-right f-14 m-b-10 bg-brand-lite btn-outline-brand"><span class="fa fa-plus m-r-10"></span>ADD MORE FIENDS</button></a>
	            </div>
	        </div>
	        ...
	        <div class="m-t-20 m-b-50">
	        	...
	        	<div class="row">
		        	<!-- first column of friends -->
		        			...
		        			<div class="col-md-6 col-sm-6 col-xs-6 col-12 m-t-30">
		        				<div class="">
			        				<div class="row">
				        				...
				        				<a href="{{ route('accept_friend', $user->reference) }}"><button class="btn btn-sm waves-light waves-effect c-brand btn-outline-brand m-t-10 m-b-5" data-email="{{$user->reference}}" data-id="{{$user->id}}" data-fname="{{$user->full_name()}}" >Accept <i class="fa fa-check"></i></button></a>
						                        ...
						                        <div class="modal-dialog" role="document">
						                            ...
						                            <div class="modal-content">
						                                ...
						                                <div class="modal-body bg-brand-lite c-dark dis-flex">
						                                    <p class="text-responsive w-700 m-0">Are you sure you want to reject this friendship?</p>
						                                </div>
						                                <!--Footer-->
		        		...
		        		@empty
		        		<h4 class="p-20 c-gray h4-responsive">No pending friend request</h4>
		        		@endforelse
